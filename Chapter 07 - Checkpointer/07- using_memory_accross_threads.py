...
# start a new chart session for sarah
print('='*70)
print("DEMOSTRATION 2: Sarah returns  (Different Day)")
print('='*70)
...
# Turn 1 Day 2: Reference stored info 
...
# Turn 2 Day 2: Suggesting food based on stored info 
...
# NEW thread for  a new person
# all memory stored for sarah will not be used for new thread created for John
print('='*70)
print("DEMOSTRATION 3: Different User - John")
print('='*70)
print("Testing Memory Isolation between user\n")



#create new config session for john
john_config = {
    "configurable":{
        "thread_id" : "chat_011",
        "user_id" : "john"
...
#output for john doesnt not use sarah fact. 